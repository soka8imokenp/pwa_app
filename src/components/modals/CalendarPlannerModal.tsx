          ...
          <div className="flex items-center gap-1.5">
            {onOpenExport && (
              <button
                ...
                className="px-2.5 py-1.5 rounded-xl bg-[#E8DCFF] hover:bg-[#D8C4FF] border border-[#18181B] flex items-center gap-1 text-[10px] font-black text-[#18181B] shadow-2xs active:scale-95 transition-all cursor-pointer"
                title="Export to .ics / Google Calendar"
              >
