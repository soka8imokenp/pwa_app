...
const COMMON_FOOD_DICTIONARY: Record<string, string> = {
  ...
  // Uzbek traditional & common foods (Latin)
  'osh': 'Uzbek Pilaf / Plov',
  'palov': 'Uzbek Pilaf / Plov',
  'somsa': 'Samsa',
  'manti': 'Manti Dumplings',
  'lagʻmon': 'Lagman Noodles',
  'lagmon': 'Lagman Noodles',
  'shoʻrva': 'Shurpa Meat Soup',
  'shorva': 'Shurpa Meat Soup',
  'norin': 'Naryn Cold Meat Noodles',
  'dimlama': 'Dimlama Stew',
  'chuchvara': 'Chuchvara Dumplings',
  'kabob': 'Shashlik Kebab',
  'shashlik': 'Shashlik / Grilled Meat',
  'non': 'Flatbread / Naan',
  'patir': 'Patyr Bread',
  'tuxum': 'Eggs',
  'qovurilgan tuxum': 'Fried Eggs',
  'qaynatilgan tuxum': 'Boiled Eggs',
  'suv': 'Water',
  'choy': 'Tea',
  'koʻk choy': 'Green Tea',
  'kok choy': 'Green Tea',
  ...
  'qoy goshti': 'Lamb',
  'tovuq': 'Chicken',
  'tovuq goʻshti': 'Chicken Breast',
  'guruch': 'Rice',
  'grechka': 'Buckwheat',
  'kartoshka': 'Potatoes',
  'kartoshka pyure': 'Mashed Potatoes',
  'olma': 'Apple',
  'banan': 'Banana',
  'shaftoli': 'Peach',
  'uzum': 'Grapes',
